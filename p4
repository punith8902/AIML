...
11/5/23, 10:13 AM ID3 Algorithm - Jupyter Notebook
localhost:8888/notebooks/Untitled Folder 2/ID3 Algorithm.ipynb 4/7
 return 1
 else:
 entropy = 0 - (
 ((p / (p + n)) * (math.log2(p / (p + n))) + (n / (p + n)) * (math.log2(n/ (p + n)))))
...
11/5/23, 10:13 AM ID3 Algorithm - Jupyter Notebook
localhost:8888/notebooks/Untitled Folder 2/ID3 Algorithm.ipynb 5/7
 childs = dict()
 for i in distinct:
...
def construct_tree(dataset, tree):
 ...
 impure_childs = []
11/5/23, 10:13 AM ID3 Algorithm - Jupyter Notebook
localhost:8888/notebooks/Untitled Folder 2/ID3 Algorithm.ipynb 6/7
...
if __name__ == "__main__":
 main()
11/5/23, 10:13 AM ID3 Algorithm - Jupyter Notebook
localhost:8888/notebooks/Untitled Folder 2/ID3 Algorithm.ipynb 7/7
